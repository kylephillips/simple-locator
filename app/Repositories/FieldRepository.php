...
class FieldRepository {
	...
	*/
	public function getFieldsForPostType($post_type)
	{
		...
		$sql = "SELECT DISTINCT meta_key FROM ".$wpdb->prefix."posts AS p LEFT JOIN ".$wpdb->prefix."postmeta AS m ON m.post_id = p.id WHERE p.post_type = '$post_type' AND meta_key NOT LIKE '\_%'";
