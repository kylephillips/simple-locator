...
<form id="wpslsearch" class="simple-locator-form">
	...
	<div class="zip">
		<label for="zip">' . $this->zip . '</label>
		<input type="tel" name="zip" id="zip" />
	</div>
	<div class="distance">
		<label for="distance">' . $this->distance . '</label>
...
if ( $this->maps_api ){
	$output .= '<script src="http://maps.google.com/maps/api/js?key=' . get_option('wpsl_google_api_key') . '&sensor=false"></script>';
} else {
