...
<div class="wpsl-modal-content small" data-wpsl-modal="post-edit-error">
	...
	<div class="wpsl-modal-content-footer">
		<a href="#" class="wpsl-cancel-trash button" data-wpsl-modal-close="modal"><?php _e('Cancel', 'simple-locator'); ?></a>
		<a href="#" class="wpsl-address-confirm button-primary" data-simple-locator-confirm-no-address><?php _e('Save without location', 'simple-locator'); ?></a>
	</div>
</div><!-- .modal-content -->