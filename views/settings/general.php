...
<tr valign="top">
	<th scope="row"><?php _e('Custom Map Pin (Results)', 'simple-locator'); ?></th>
	<td>
...
<tr valign="top">
	<th scope="row"><?php _e('User Map Pin', 'simple-locator'); ?></th>
	<td>
...
<tr valign="top" data-simple-locator-user-map-pin>
	<th scope="row"><?php _e('Custom Map Pin (User Location)', 'simple-locator'); ?></th>
	<td>
		<div style="float:left;" data-simple-locator-map-pin-image-container>
			<?php 
