<div class="simple-locator-import-tab">
	...
	elseif ( !$apikey ) :
		echo '<div class="error"></p>' . __('Import functionality requires a Google Maps API key. The key must have the Geocoding API enabled. To enter an API key, visit the Simple Locator general settings tab.', 'wpsimplelocator') . '</p></div>';
	else :
		// Steps
