...
<tr valign="top">
	<td colspan="2">
		...
		<label><input type="checkbox" name="wpsl_custom_map_options" value="1" id="wpsl_custom_map_options" data-simple-locator-custom-map-options-checkbox <?php if ( $this->settings_repo->customMapOptions() ) echo 'checked'; ?>><?php _e('Customize Javscript Map Options', 'wpsimplelocator');?></label>
